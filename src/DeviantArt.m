...
// SET THESE!
NSString *const kDAOEClientID = @"";
NSString *const kDAOECLientSecret = @"";
// the app needs to declare that it handles the protocol in this url!
// see the "URL types" key in dAOAuthExample-Info.plist
NSString *const kDAOERedirectURL = @"daoathexample://oauth2";
...
// other consts
NSString *const kDAOEMimeBoundary = @"dAOAuthExampleAppIsFun";
